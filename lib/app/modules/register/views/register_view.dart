        ...
        body: SafeArea(
          child: Padding(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  suffix: InkWell(
                    child: Icon(usersC.isPasswordHide.value ? Icons.visibility : Icons.visibility_off, color: Colors.grey,size: 20,),
                    onTap: (){
                      usersC.isPasswordHide.value=!usersC.isPasswordHide.value;
                    },
                  ),
